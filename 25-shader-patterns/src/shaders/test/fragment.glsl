...
float lerp(float val, float oldMin, float oldMax, float newMin, float newMax) {
...
void main() {
    ...
    // patern 30
    // float strength = 0.015 / distance(vec2(vUv.x * 0.2 + 0.4, vUv.y * 0.5 + 0.25), vec2(0.5));
    ...
    // patern 32
    // vec2 rotatedUv = rotate(vUv, M_PI / 4.0, vec2(0.5));
